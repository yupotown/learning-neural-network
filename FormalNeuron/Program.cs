...
namespace NeuralNetwork
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // xor
            var xorInput = ConstOutput.CreateArray(false, true);
            ...
            xorOutputNeuron.SetInputs(xorInput);
            ...
            while (true)
            {
                ...
                {
                    xorInput[0].Set(prms[0]);
                    xorInput[1].Set(prms[1]);
